...
let icon_rigth="M0.25 5.25C0.25 5.00147 0.453507 4.8 0.704545 4.8L8.69808 4.8L5.38313 1.5182C5.20562 1.34246 5.20562 1.05754 5.38313 0.881802C5.56064 0.706066 5.84845 0.706066 6.02596 0.881802L10.1169 4.9318C10.2944 5.10754 10.2944 5.39246 10.1169 5.5682L6.02596 9.6182C5.84845 9.79393 5.56064 9.79393 5.38313 9.6182C5.20562 9.44246 5.20562 9.15754 5.38313 8.9818L8.69808 5.7L0.704545 5.7C0.453507 5.7 0.25 5.49853 0.25 5.25Z"
export default function carrousel() {
  return (
    <div  id="bg-container-main" className="hidden md:block bg-[#5b34c5] md:w-[90%] lg-w-[90%] xl-w-[95%] md:h-[24vh] md:flex rounded-[15px] " >
        ...
        <button><Arrow icon={icon_left}/></button>  
        </div>
...
<img className="md:h-[11rem] lg:w-[7rem] md:mb-[3rem] lg:mr-[4rem] xl:w-[9rem] xl:h-[11rem]" src="/banner-home.png" alt="" />
        ...
        <button><Arrow icon={icon_rigth}/></button> 
