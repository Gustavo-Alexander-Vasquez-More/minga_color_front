  ...
  return (
    <footer className="w-full h-[27vh] flex flex-col justify-around items-center lg:h-[50vh] md:h-[40vh] sm:py-[1rem] ">
      ...
      <div className="flex w-full h-[5vh] text-[1.3rem] justify-around px-[5rem]">
        <a href=""><h2>Home</h2></a>
        <a href=""><h2>Mangas</h2></a>
      </div>
      <a href=""><div className="flex justify-center">
      ...
      <a href=""><svg class="w-6 h-6 text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 8 19">
    <path fill-rule="evenodd" d="M6.135 3H8V0H6.135a4.147 4.147 0 0 0-4.142 4.142V6H0v3h2v9.938h3V9h2.021l.592-3H5V3.591A.6.6 0 0 1 5.592 3h.543Z" clip-rule="evenodd"/>
  </svg></a>
  <a href=""><svg class="w-6 h-6 text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 17">
...
<a href=""><svg class="w-6 h-6 text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 14">
